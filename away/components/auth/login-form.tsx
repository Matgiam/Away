		...
		<div className={cn("w-full max-w-md", className)} {...props}>
			<div className="rounded-2xl border border-white/10 bg-[#0a0118]/80 backdrop-blur-xl shadow-2xl px-8 py-10">
				<div className="mb-8 text-center">
					<h1 className="text-4xl italic font-light text-white mb-2">Login</h1>
					<p className="text-sm text-white/40 italic">Welcome back. Enter your details to continue.</p>
				</div>
				...
				<form onSubmit={handleLogin} className="flex flex-col gap-5">
					...
					<div className="flex flex-col gap-2">
						<div className="flex items-center justify-between">
							...
							<Link href="/auth/forgot-password" className="text-xs italic text-white/40 hover:text-white transition-colors">
								Forgot?
							</Link>
						</div>
						<input
					...
					<div className="relative my-1">
						...
						<div className="relative flex justify-center text-[10px] uppercase tracking-widest">
							<span className="bg-[#0a0118] px-3 text-white/40">Or continue with</span>
						</div>
					</div>
					...
					<button
						...
						disabled={isLoading}
						className="w-full rounded-xl border border-white/10 bg-white/5 px-5 py-3 text-sm italic text-white hover:bg-white/10 transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
					>
